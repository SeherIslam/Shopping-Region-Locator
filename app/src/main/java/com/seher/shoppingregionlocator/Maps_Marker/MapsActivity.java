package com.seher.shoppingregionlocator.Maps_Marker;
...
public class MapsActivity extends FragmentActivity implements
    ...
    public void search()
    {
        ...
        GetNearbyPlaces getNearbyPlaces = new GetNearbyPlaces(BitmapDescriptorFactory.HUE_YELLOW);
        GetNearbyPlaces getNearbyPlaces1 = new GetNearbyPlaces(BitmapDescriptorFactory.HUE_VIOLET);
        GetNearbyPlaces getNearbyPlaces2 = new GetNearbyPlaces(BitmapDescriptorFactory.HUE_BLUE);
...
//                Toast.makeText(this, "Showing nearby Hospitals", Toast.LENGTH_SHORT).show();
    ...
    private String getUrl(double latitude, double longitude, String nearbyPlace){
        ...
        googleURL.append("&key="+"AIzaSyDS5JMA46n9vDeLf8mZv67lTUheSKTApWY");
